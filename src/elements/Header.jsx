        ...
        <div className="w-full h-full text-white bg-cyan-950">
            ...
            <div className="absolute z-20 text-center md:text-left top-24 md:w-full">
                ...
                <div className="relative w-full mt-8 md:right-0 md:top-44 md:absolute">
                    ...
                    <img src={Icon1} alt="icon" className="absolute z-5 w-44 left-0.5 md:scale-y-150 md:left-2/4 md:ml-16 md:mt-1 md:top-44"/>
                    <img src={Icon2} alt="icon" className="absolute z-10 w-44 top-12 md:-top-12 right-1 md:scale-150 md:right-60"/>
                </div>
            </div>
        </div>
     );
